...
const AutoInvestThreeComponent = () => {
            ...
            <div className={styles.autoInvest}>
                ...
                <div className={styles.container}>
                    <div className={styles.sideContainer}>
                        <div className={styles.head}>Can i still invest manually if i have Auto Invest</div>
                        <ul>
                        ...
                        <div className={styles.head}>Investments & Earnings</div>
                        <ul>
                            <li>Calculations and display of earnings</li>
                            <li>Investments</li>
                        </ul>
                    </div>
...
export default AutoInvestThreeComponent;
